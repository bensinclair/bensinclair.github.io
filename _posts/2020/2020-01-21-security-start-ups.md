---
layout: post
title:  "Security for start-up software companies"
description:  "Aside from trying to write secure code, it can be difficult knowing what to do when it comes to security. Here are 4 things to consider."
tags: [ security ]
...
Something I've found really helpful is choosing a cybersecurity framework that you want to follow. For example, [NIST](https://www.nist.gov/cyberframework) and [OWASP](https://owasp.org/) have some great things you can adapt to and follow. They all have similar yet different approaches and have practical ways to help secure your applications.
