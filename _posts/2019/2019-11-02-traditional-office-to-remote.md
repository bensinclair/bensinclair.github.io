---
layout: post
title:  "Moving from a traditional office to fully remote"
description:  "Our company moved from a traditional workspace to a fully remote environment. Here is our story."
tags: [ remote ]
...
Our team was already on [Slack](https://slack.com) which is a great way to quickly communicate whether in the office or remote. Tithe.ly had been using [Zoom](https://zoom.us) for video conferencing for years so we took that on for our team also.

We use [Google Calendar](https://calendar.google.com/) now when we need to book in time to meet with someone. I try to avoid calling someone out of the blue.

We use software like Atlassian's [Confluence](https://www.atlassian.com/software/confluence) and [Jira](https://www.atlassian.com/software/jira) to collaborate with our teams.
...
To keep connected, we run a monthly catch up that we've called [Fika](http://www.swedishfood.com/fika). Everyone needs to grab a snack and a drink and we jump on a video call for half an hour. We generally have a topic to chat about such as what shoes you're wearing, what's your favorite food, where have you traveled. You can get creative!
...
I recently read the book [Remote](https://basecamp.com/books/remote) written back in 2013 by the [37signals](https://37signals.com/) guys. I'd highly recommend EVERYONE to read this book. Whether you're against having your team working remotely, skeptical, thinking about doing it or have done it - it's a great resource and still holds up 6 years on. 

I'd also recommend listening to a TED Talk by the same guy who wrote the above book, [Jason Fried](https://twitter.com/jasonfried), titled, [Why Work Doesn't Happen At Work](https://www.ted.com/talks/jason_fried_why_work_doesn_t_happen_at_work/up-next?language=en). It's gold.
